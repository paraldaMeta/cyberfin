...
const MARKETS = [
  ...
  { id: 'th_stock', name: '泰股', icon: '🇹🇭', description: '泰国股票市场' },
  { id: 'futures', name: '期货', icon: '📊', description: '商品期货市场' },
  { id: 'forex', name: '外汇', icon: '💱', description: '外汇市场' },
];
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-2xl md:text-3xl font-bold text-white font-market">市场总览</h1>
          <p className="text-sm text-[#a1a1aa] mt-1">全亚洲金融市场实时行情</p>
        </div>
        ...
        <Card className="bg-[#141824] border-[#2a2f3e]">
          <CardHeader className="pb-3">
            <CardTitle className="flex items-center gap-2 text-lg">
              ...
              <span className="text-white">涨幅榜</span>
            </CardTitle>
          </CardHeader>
          <CardContent>
            {loading ? (
        ...
        <Card className="bg-[#141824] border-[#2a2f3e]">
          <CardHeader className="pb-3">
            <CardTitle className="flex items-center gap-2 text-lg">
              ...
              <span className="text-white">跌幅榜</span>
            </CardTitle>
          </CardHeader>
          <CardContent>
            {loading ? (
      ...
      <Card className="bg-[#141824] border-[#2a2f3e]">
        <CardHeader className="pb-3">
          <CardTitle className="flex items-center gap-2 text-lg">
            ...
            <span className="text-white">实时行情</span>
          </CardTitle>
        </CardHeader>
        <CardContent>
          {loading ? (
